...
for target_i in target_amounts:
    while amount_of_films < target_i:
        try:
            ...
            if (movie_info['title'] and
                    movie_info['release_date'] and
                    movie_info['runtime'] and
                    movie_info['backdrop_path'] and
                    movie_info['poster_path'] and
                    movie_info['imdb_id'] and
                    movie_info['overview'] and
